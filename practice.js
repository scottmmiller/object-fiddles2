...
//Now, loop through your states object and if the states population is greater than 300K, alert that state.
...
//Once you get your truthy Object, Change the remaining values in the object to be specific to you (name: 'your name', username: 'your username'), rather than my information.
  ...
  //Code Here
user.name = 'Skoot';
user.pwHash = 'Uksdj333ls';
user.username = 'smmiller.work';
